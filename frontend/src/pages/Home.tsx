      ...
      <div className="py-20 md:py-32 px-4 md:px-8">
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            ...
            <div className="w-full max-w-2xl bg-white border border-slate-200 rounded-xl overflow-hidden shadow-2xl flex flex-col h-[200px] md:h-[320px]">
              <div className="bg-slate-100 px-3 md:px-4 py-2 md:py-3 border-b border-slate-200 flex items-center gap-2">
                <div className="w-2.5 h-2.5 md:w-3 md:h-3 rounded-full bg-slate-300"></div>
                <div className="w-2.5 h-2.5 md:w-3 md:h-3 rounded-full bg-slate-300"></div>
                <div className="w-2.5 h-2.5 md:w-3 md:h-3 rounded-full bg-slate-300"></div>
                <div className="mx-auto text-[10px] md:text-xs font-mono font-bold text-slate-500">student@academy: ~/learning-path</div>
              </div>
              
              <div 
                className="flex-1 p-4 md:p-6 font-mono text-xs md:text-sm leading-relaxed overflow-hidden flex flex-col"
              ...
              >
                ...
                <form className="flex items-center gap-2 md:gap-3 pt-3 md:pt-4 mt-2 border-t border-slate-100" onSubmit={e => { e.preventDefault(); runCommand(input); setInput(''); }}>
                  <span className="text-brand-orange font-bold whitespace-nowrap text-xs md:text-sm">student@academy:~$</span>
                  <input
                    type="text"
                    className="flex-1 bg-slate-50 border border-slate-200 text-slate-900 px-2 py-1.5 md:px-3 md:py-2 rounded-lg focus:outline-none focus:border-brand-orange focus:ring-2 focus:ring-orange-100 transition-all font-mono shadow-inner text-xs md:text-sm"
                    spellCheck="false"
                    autoCapitalize="off"
                    autoComplete="off"
